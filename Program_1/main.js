...
Map.addLayer(combinedCollection.first(), {}, 'First Interval Average');
...
function reduceToRegion(image) {
  ...
  return ee.Feature(null, stats).set('date', date.format('YYYY-MM'));
}
...
Export.table.toDrive({
  ...
  description: 'MonthlyTimeSeriesExport',
  folder: 'GEE_Exports',
  fileNamePrefix: 'Monthly_TimeSeries_Data',
  fileFormat: 'CSV'
});
